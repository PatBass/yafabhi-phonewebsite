<div class = "block_in_wrapper">
	...
	<fieldset>
            ...
            <div class="row"><label for="startdate">{#startdate#}:</label><input type="text" class="text" name="startdate" id="startdate" required="1" realname="{#startdate#}" date="{"Ymd"|date:$pro.start}" value="{$settings.dateformat|date:$pro.start}" /></div>
            <div class="datepick">
                <div id = "add_project_start" class="picker" style = "display:none;"></div>
            </div>
            
            <div class="row"><label for="finishdate">{#finishdate#}:</label><input type="text" class="text" name="finishdate" id="finishdate" required="1" realname="{#finishdate#}" date="{"Ymd"|date:$pro.end}" value="{$settings.dateformat|date:$pro.end}"  /></div>
