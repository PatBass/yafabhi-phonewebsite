...
{section name=list loop=$lists}
			...
			<div class="headline">
				...
				<div class="wintools">
                    <a href="#" style="background:none;font-weight:bold;color:{if $lists[list].daystostart > 0}#99cc00{else}#ff4444{/if};width:35px;font-size:16px;">{$lists[list].daystostart}<span>Days left until Start</span></a>
                    <a href="#" style="background:none;font-weight:bold;color:{if $lists[list].daystofinish > 0}#99cc00{else}#ff4444{/if};width:35px;font-size:16px;">{$lists[list].daystofinish}<span>Days left until Finish</span></a>
