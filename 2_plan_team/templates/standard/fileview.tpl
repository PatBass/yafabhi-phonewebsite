									...
									<div class="itemwrapper" id="iw_{$files[file].ID}">
											...
											<table cellpadding="0" cellspacing="0" border="0">
												<tr>
													...
													<td class="thumb">
													 	<a href = "managefile.php?action=download&amp;file={$files[file].ID}" {if $files[file].imgfile == 1} rel="lytebox[]" {elseif $files[file].imgfile == 2} rel = "lyteframe[text]" rev="width: 650px; height: 500px;"{/if}>
												...
												<tr>
													<td colspan="3">
														<span class="name">
															<a href = "managefile.php?action=download&amp;file={$files[file].ID}"{if $files[file].imgfile == 1} rel="lytebox[img{$files[file].ID}]" {elseif $files[file].imgfile == 2} rel = "lyteframe[text{$files[file].ID}]"{/if} title="{$files[file].name}" onmousedown = "change('managefile.php?action=makeseen&file={$files[file].ID}&id={$project.ID}','jslog');">
																{if $files[file].title != ""}
