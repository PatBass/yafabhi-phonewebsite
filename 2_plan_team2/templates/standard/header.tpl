...
<title>Yafabhi - Project Management</title>
...
<body style="background-image: url('http://yafabhi.com/2_plan_team2/templates/standard/images/bgtile.jpg');background-repeat: repeat;">
