		...
		<div id="header">
			<div class="header-in">
				...
				<div class="left">
					<div class="logo">
						<h1>
							<a href="index.php" title="Yafabhi Company"><img src="./templates/standard/images/logo-b.png" alt="" /></a>
							<!--<span class="title"><span class="subtitle">Yafabhi Company Project Management</span></span>-->
						</h1>
					</div>
