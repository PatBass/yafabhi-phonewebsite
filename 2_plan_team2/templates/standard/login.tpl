...
<div class="login">
	<div class="login-in">
		<div class="logo-name">
			<h1><a href = "http://yafabhi.com/" title = ""><img src="./templates/standard/images/logo-a.png" alt=""  /></a></h1>
			<h2 style="color: #ddd;">Yafabhi Company Project Management</h2>
		</div>
...
<p><font color="#559dd7">Supported browsers: Firefox, Chrome, Safari</font></p>
