...
$projectsMain = "#365a76";	//$projectsMain = "#3f7174";
$projectsB = "#869cad";	//$projectsB = "#8caaac"; // Borders in Forms
$projectsC = "#203d56";	//$projectsC = "#275154"; // Buttons Hover
$projectsBlockhead = "#6699CC";	//$projectsBlockhead = "url(../images/tables-projects-head.png)";
$projectsTablehead = "url(../images/tables-tasks-thead.png)";	//$projectsTablehead = "url(../images/tables-projects-thead.png)";
$projectsTableSecondhead = "url(../images/tables-tasks-sechead.png)";	//$projectsTableSecondhead = "url(../images/tables-projects-sechead.png)"; // closed Things
$projectsColorA = "url(../images/tables-tasks-bg-a.png)";	//$projectsColorA = "url(../images/tables-projects-bg-a.png)"; // ColorMix Rows
$projectsColorB = "url(../images/tables-tasks-bg-b.png)";	//$projectsColorB = "url(../images/tables-projects-bg-b.png)"; // ColorMix Rows
$projectsColorC = "url(../images/tables-tasks-bg-c.png)";	//$projectsColorC = "url(../images/tables-projects-bg-c.png)"; // Files in Messages

$tasksMain = "#365a76";
$tasksB = "#869cad"; // Borders in Forms
$tasksC = "#203d56"; // Buttons Hover
$tasksBlockhead = "#6699CC";	//$tasksBlockhead = "url(../images/tables-tasks-head.png)";
...
$msgsMain = "#365a76";	//$msgsMain = "#65635e";
$msgsB = "#869cad";	//$msgsB = "#a3a19e"; // Borders in Forms
$msgsC = "#203d56";	//$msgsC = "#464440"; // Buttons Hover
$msgsBlockhead = "#6699CC";	//$msgsBlockhead = "url(../images/tables-msgs-head.png)";
$msgsTablehead = "url(../images/tables-tasks-thead.png)";	//$msgsTablehead = "url(../images/tables-msgs-thead.png)";
$msgsTableSecondhead = "url(../images/tables-tasks-sechead.png)";	//$msgsTableSecondhead = "url(../images/tables-msgs-sechead.png)"; // closed Things
$msgsColorA = "url(../images/tables-tasks-bg-a.png)";	//$msgsColorA = "url(../images/tables-msgs-bg-a.png)"; // ColorMix Rows
$msgsColorB = "url(../images/tables-tasks-bg-b.png)";	//$msgsColorB = "url(../images/tables-msgs-bg-b.png)"; // ColorMix Rows
$msgsColorC = "url(../images/tables-tasks-bg-c.png)";	//$msgsColorC = "url(../images/tables-msgs-bg-c.png)"; // Files in Messages

$userMain = "#365a76";
$userB = "#869cad"; // Borders in Forms
$userC = "#203d56"; // Buttons Hover
$userBlockhead = "#6699CC";
$userTablehead = "url(../images/tables-tasks-thead.png)";
$userTableSecondhead = "url(../images/tables-tasks-sechead.png)"; // closed Things
$userColorA = "url(../images/tables-tasks-bg-a.png)"; // ColorMix Rows
$userColorB = "url(../images/tables-tasks-bg-b.png)"; // ColorMix Rows
$userColorC = "url(../images/tables-tasks-bg-c.png)"; // Files in Messages

$milesMain = "#365a76";
$milesB = "#869cad"; // Borders in Forms
$milesC = "#203d56"; // Buttons Hover
$milesBlockhead = "#6699CC";	//$milesBlockhead = "url(../images/tables-miles-head.png)";
$milesTablehead = "url(../images/tables-tasks-thead.png)";
$milesTableSecondhead = "url(../images/tables-tasks-sechead.png)"; // closed Things
$milesColorA = "url(../images/tables-tasks-bg-a.png)"; // ColorMix Rows
$milesColorB = "url(../images/tables-tasks-bg-b.png)"; // ColorMix Rows
$milesColorC = "url(../images/tables-tasks-bg-c.png)"; // Files in Messages

$neutralMain = "#365a76";
$neutralB = "#869cad"; // Borders in Forms
$neutralC = "#203d56"; // Buttons Hover
$neutralBlockhead = "#6699CC";
$neutralTablehead = "url(../images/tables-tasks-thead.png)";
$neutralTableSecondhead = "url(../images/tables-tasks-sechead.png)"; // closed Things
$neutralColorA = "url(../images/tables-tasks-bg-a.png)"; // ColorMix Rows
$neutralColorB = "url(../images/tables-tasks-bg-b.png)"; // ColorMix Rows
$neutralColorC = "url(../images/tables-tasks-bg-c.png)"; // Files in Messages

$timetrackMain = "#365a76";
$timetrackB = "#869cad"; // Borders in Forms
$timetrackC = "#203d56"; // Buttons Hover
$timetrackBlockhead = "#6699CC";
$timetrackTablehead = "url(../images/tables-tasks-thead.png)";
$timetrackTableSecondhead = "url(../images/tables-tasks-sechead.png)"; // closed Things
...
$timetrackColorC = "url(../images/tables-tasks-bg-c.png)"; // Files in Messages

$filesMain = "#365a76";
$filesB = "#869cad"; // Borders in Forms
$filesC = "#203d56"; // Buttons Hover
$filesBlockhead = "#6699CC";
$filesTablehead = "url(../images/tables-tasks-thead.png)";
$filesTableSecondhead = "url(../images/tables-tasks-sechead.png)"; // closed Things
$filesColorA = "url(../images/tables-tasks-bg-a.png)"; // ColorMix Rows
$filesColorB = "url(../images/tables-tasks-bg-b.png)"; // ColorMix Rows
$filesColorC = "url(../images/tables-tasks-bg-c.png)"; // Files in Messages
...
body {
	color:#082343;
	background: url("../images/main-bg-new.jpg") repeat-x fixed 0 0 #2D6E98;
	/* background-color: #fff;  background:#2d6e98 url(../images/main-bg.jpg) repeat-x 0 0; */
...
.menu ul{
	...
	.menu li a{
		...
		.menu li a:hover, .menu ul li:hover a{
			background: #fff url("../images/hover_green.gif") bottom center no-repeat;
			color:#2081b0;
			text-decoration:none;
			}
	.menu li ul{
	...
	.menu li ul a{
		...
		.menu ul li a:hover {
			background:#fff url('../images/hover_sub_green.gif') center left no-repeat;
			border:none;
			color:#2081b0;
			text-decoration:none;
			}
...
#header-wrapper {
	width:100%;
	height: 70px;
	background-color: #fff; /* background: url(../images/color-a.png) repeat 0 0; */
}
...
#content-right h2 a.win-up, #content-right h2 a.win-down {
	...
	width: 100%;
	height: 35px;
	background: #6699cc url("../images/win-up.png") no-repeat scroll 190px 8px;
	color: #fff;
	text-indent: 10px;
}

 #content-right h2 a.win-down {
	background: #6699cc url("../images/win-up.png") no-repeat scroll 190px -54px;
 }

#content-right h2 a.win-up:hover {
	background-position: 190px -23px;
}

#content-right h2 a.win-down:hover {
...
#search button {
	background: #ddd url("../images/search-butn-side.png") no-repeat scroll right 0;	
	margin-left: 10px;
	}	
...
.statusbar .complete, .statusbar_b .complete {
	height:	12px;
	background: url(../images/statusbar_complete_b_green.jpg) repeat-x 0 0;
}

.statusbar_b .complete {
	height: 8px;
	background: url(../images/statusbar_complete_b_green.jpg) repeat-x 0 -1px;
}
...
.projects .headline, .projects a.butn_link, .projects button, .projects a.butn_link_active:hover, .projects .inmenue a span, .projects .moreinfo {
	background-color: <?php echo $projectsBlockhead;
?>;
}
...
.tasks .headline, .tasks a.butn_link, .tasks button, .tasks a.butn_link_active:hover, .tasks .inmenue a span, .tasks .moreinfo {
	background-color: <?php echo $tasksBlockhead;
?>;
}
...
.msgs .headline, .msgs a.butn_link, .msgs button, .msgs a.butn_link_active:hover, .msgs .inmenue a span, .msgs .moreinfo, .msgs .inmenue a span, .msgs .moreinfo {
	background-color: <?php echo $msgsBlockhead;
?>;
}
...
.miles .headline, .miles a.butn_link, .miles button, .miles a.butn_link_active:hover, .miles .calinmenue ul {
	background-color: <?php echo $milesBlockhead;
?>;
}
