...
<h2>{#addproject#}</h2>
	...
	<fieldset>
        ...
        <input type="text" class="text" name="start"  id="start"  realname="{#startdate#}" required="1" regexp="{literal}\d{2}.\d{2}.\d{2,4}{/literal}" />
        </div>
		...
		<input type="text" class="text" name="end"  id="end"  realname="{#finishdate#}" required="1" regexp="{literal}\d{2}.\d{2}.\d{2,4}{/literal}" />
		<br /><br />
		</div>
