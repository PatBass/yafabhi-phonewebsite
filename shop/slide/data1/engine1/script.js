...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"stack",prev:"",next:"",duration:15*100,delay:19*100,width:1180,height:400,autoPlay:true,playPause:false,stopOnHover:true,loop:false,bullets:1,caption:false,captionEffect:"slide",controls:false,onBeforeStep:0,images:0});