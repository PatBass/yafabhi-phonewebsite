...
<section class="row" >
    ...
    <div class="col-md-8 col-md-offset-2" style="margin-top: 50px; margin-bottom: 50px; border:2px solid white; background-color:#f5f5f5 ; border-radius: 5px;">
        ...
        <p>Welcome, <strong><?php echo $_SESSION['user']; ?></strong>.<br />
            <font color="green">This Is Your Admin Zone</font> </p>
        <br>

        <a class="btn btn-primary" href="index.php?module=admin_products&action=admin_products_show">Click here to add/delete or update products</a>
        <br><br>
    </div>
